...
from pkg.load_data_property import connect_to_data_manhattan
from pkg.load_data_construction import connect_to_bigquery_manhattan
...
with tab1:
    ...
    df_construction = connect_to_bigquery_manhattan(table)
...
with tab2: 
    ...
    # avg price of sold properties per square foot
