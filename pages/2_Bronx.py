...
from pkg.load_data_property import connect_to_data_bronx
from pkg.load_data_construction import connect_to_bigquery_bronx
...
with tab2: 
    ...
    df_land = connect_to_data_bronx(table)
